...
<html>
<head>
<title>Assignment 2 Painting with the Mouse | Ruofei Du</title>
<meta charset="UTF-8">
...
<section id="one">
<header class="major">
	<h2>WebGL MOOC Assignment 2: Painting with the Mouse</h2>
</header>
<p>This demo allows users to draw lines with different stroke color and width with a mouse. 
<i>Please scroll down for the interactive control panel and draw within the dashed boundary.</i>
</p>

<p>Drawing platform independent lines is very hard in WebGL. Here are references on 
<a href="https://forum.libcinder.org/topic/smooth-thick-lines-using-geometry-shader" target="_blank">
smooth thick lines
</a> and 
<a href="http://mattdesl.svbtle.com/drawing-lines-is-hard" target="_blank">
why drawing lines is hard in WebGL
</a></p>
...
<div class="row">
<div class="col-md-4" id="color_label">Stroke Color:</div>
<div class="col-md-7">
...
<div class="row">
<div class="col-md-4" id="width_label">Line Width:</div>
<div class="col-md-7" style="margin-top: 10px;"><div id="linewidth"></div></div>
<div class="col-md-1" id="linewidth_value">1</div>
</div>
...
<ul class="actions">
	...
	<li><a id="undo" class="button">Undo</a></li>
</ul>
</div>
</div>
</ul>
