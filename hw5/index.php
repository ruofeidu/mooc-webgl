...
<html>
<head>
<title>Assignment 5: Texture Mapping to a Sphere | Ruofei Du</title>
<meta charset="UTF-8">
...
void main()
{
	...
	cCube = textureCube(cubeMap, vPosition.xyz);
    fColor.a = 1.0;
}
</script>
...
{
	if (texMode == 0) {
		gl_FragColor = texture2D( t0, vec2(s, t)) + fColor * 0.1;
	} else 
	if (texMode == 1) {
		gl_FragColor = texture2D( t1, vec2(s, t)) + fColor * 0.2;
	} else 
	if (texMode == 2) {
		gl_FragColor = cCube;
	} else {
...
<section id="one">
<header class="major">
	<h2>WebGL MOOC Assignment 5: Texture Mapping to a Sphere</h2>
</header>
<p>This demo demonstrates basic spherical texture mapping using WebGL. It includes both spherical projection and 6 cube map images projection.
</p>
...
<div class="col-md-2 hidden" id="light_label">Lights:</div>
<div class="col-md-4">
<ol id="lightlist">
...
<div class="row textureui">
<div class="col-md-4" id="color_label">Texture:</div>
<div class="col-md-7">
<div id="tm">
<input type="radio" id="tm0" name="tm" value="0" checked><label for="tm0">Brick Image</label>
<input type="radio" id="tm1" name="tm" value="1" ><label for="tm1">Checkerboard Pattern</label>
<input type="radio" id="tm2" name="tm" value="2" ><label for="tm2">Cube Map Images</label>
<input type="radio" id="tm3" name="tm" value="3" ><label for="tm3">No Texture</label>
</div>
</div>
</div>
...
<img id="texImage" src="images/tex00.jpg" hidden></img>
<img id="texCheckerboard" src="images/checkerboard.jpg" hidden></img>
