...
<p>This demo allows users to render some simple geometries using shaders.</i> The control panel is below. Please zoom out the webpage so both control panel and the scene show up at the same time.
</p>
...
<div class="col-md-7">
<div id="shape">
<input type="radio" id="shape1" name="shape" value="0" checked="checked"><label for="shape1">Cube</label>
<input type="radio" id="shape2" name="shape" value="1" ><label for="shape2">Cone</label>
<input type="radio" id="shape3" name="shape" value="2" ><label for="shape3">Sphere</label>
</div>
</div>
</div>
...
<div class="col-md-7">
<ol id="selectable">
  <li class="ui-widget-content ui-selected">Cube</li>
  <li class="ui-widget-content">Sphere</li>
  <li class="ui-widget-content">Cone</li>
</ol>
</div>
</div>
